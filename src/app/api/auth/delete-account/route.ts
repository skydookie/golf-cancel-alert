...
// 계정 완전 탈퇴 — 암호화된 자격증명을 포함한 개인 데이터가 조회 불가능한 상태로 완전히
// 삭제되어야 한다(비활성화만으로는 불충분). Prisma 스키마의 각 관계가 onDelete: Cascade로
// 선언되어 있어, User 레코드 삭제 한 번으로 FacilityCredential / WatchCondition /
